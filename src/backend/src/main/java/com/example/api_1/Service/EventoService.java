...
public class EventoService {
    ...
    public void adicionar_evento(EventoModel evento){
        ...
        BarModel bar = barRepository.findById(evento.getId_evento()).get();
        ContratanteEventoModel contratanteEvento = contratanteEventoRepository.findById(evento.getId_evento()).get();
